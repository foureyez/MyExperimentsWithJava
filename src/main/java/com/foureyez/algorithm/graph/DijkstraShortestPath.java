...
public class DijkstraShortestPath {
	...
	/**
	 * This method gives a shorted path array using Djikstra's algorithm by
	 * consuming a graph.
	 * 
	 * @param source - Source vertex from which search starts.
	 * @param target - Target vertex to which the shortest path is calculated.
	 */
	...
	/**
	 * This method gives a shorted path array using Djikstra's algorithm by
	 * consuming a graph in the form of 2-D array.
	 * 
	 * @param graph  - 2D array of weighted graph.
	 * @param source - Source vertex from which the shortest distance of all the
	 *               nodes is calculated.
	 * @return Array dist[V] containing the minimum distance of each vertex from the
	 *         source.
	 */
	public int[] findShortestPath(int[][] graph, int source) {
		...
		/*
		 * Set Each vertex as not visited and distance of each vertex from source is
	...
	/**
	 * @param graph  - Array of arrayList to define the adjacency list for each
	 *               vertex.
	 * @param source - Source vertex from which the shortest distance of all the
	 *               nodes is calculated.
	 * @return Array dist[V] containing the minimum distance of each vertex from the
